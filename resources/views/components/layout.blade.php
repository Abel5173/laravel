...
<body class="h-full ">
    ...
    <nav class="bg-gray-800">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
            ...
            <div class="ml-3">
                <div class="text-base font-medium leading-none text-white">Abel Zeleke</div>
                <div class="text-sm font-medium leading-none text-gray-400">abelzeleke5173@gmail.com</div>
            </div>
